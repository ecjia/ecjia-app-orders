...
class admin_sale_general extends ecjia_admin
{
    ...
    public function init()
    {
        ...
        ecjia_screen::get_current_screen()->set_help_sidebar('<p><strong>' . __('更多信息：', 'orders') . '</strong></p>' . '<p>' . __('<a href="https://ecjia.com/wiki/帮助:ECJia智能后台:销售概况" target="_blank">' . __('关于销售概况帮助文档', 'orders') . '</a>') . '</p>');
