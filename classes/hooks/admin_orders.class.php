...
RC_Hook::add_action('admin_dashboard_left', array('orders_admin_plugin', 'widget_admin_dashboard_shopstats_left'));
RC_Hook::add_action('admin_dashboard_right', array('orders_admin_plugin', 'widget_admin_dashboard_shopstats_right'));
