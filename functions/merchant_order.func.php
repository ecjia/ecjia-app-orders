...
function get_merchant_delivery_list()
{
    ...
    /* 记录总数 */
    $type_count = $db_delivery_order->select(
        RC_DB::raw('count(*) as count_goods_num'),
    ...
    $row = $db_delivery_order->select(
        ...
        RC_DB::raw('do.suppliers_id'), RC_DB::raw('do.order_id'), RC_DB::raw('do.order_sn'), RC_DB::raw('do.add_time'))
