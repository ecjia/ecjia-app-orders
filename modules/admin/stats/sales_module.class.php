 ...
 * @author will.chen
 */
class admin_stats_sales_module extends api_admin implements api_interface
{
    public function handleRequest(\Royalcms\Component\HttpKernel\Request $request)
    {
        ...
        if (empty($data)) {
            $response = $this->sales_module($start_date, $end_date);
    ...
    private function sales_module($start_date, $end_date)
    {
