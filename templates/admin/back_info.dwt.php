...
<!-- 										<a href="exchange_goods.php?act=edit&id={$back_order.extension_id}">{$lang.exchange_goods}</a> -->
				...
				<div class="accordion-group">
					...
					<div class="accordion-body in collapse" id="collapseThree">
						<table class="table table-striped m_b0 order-table-list">
							<tbody>
								<tr class="table-list">
									<td>{$lang.goods_name_brand}</td>
									<td>{$lang.goods_sn}</td>
									<td>{$lang.product_sn}</td>
									<td>{$lang.goods_attr}</td>
									<td>{$lang.label_send_number}</td>
								</tr>
				...
				<div class="accordion-group">
					<div class="accordion-heading">
						<a class="accordion-toggle acc-in" data-toggle="collapse" href="#collapseFour"><strong>{$lang.action_info}</strong></a>
					</div>
