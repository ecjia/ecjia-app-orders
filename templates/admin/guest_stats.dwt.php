			...
			<div class="accordion-body in collapse" id="user">
				<table class="table table-oddtd m_b0">
					<tbody class="first-td-no-leftbd">
						<tr>
							<td><div align="right"><strong>{t}会员总数{/t}</strong></div></td>
							<td>{$user_num}</td>
							<td><div align="right"><strong>{t}有订单会员数{/t}</strong></div></td>
							<td>{$have_order_usernum}</td>
						</tr>
						<tr>
							<td><div align="right"><strong>{t}会员订单总数{/t}</strong></div></td>
							<td>{$user_order_turnover}</td>
							<td><div align="right"><strong>{t}会员购买率{/t}</strong></div></td>
							<td>{$user_ratio}%</td>
						</tr>
					</tbody>
				</table>
		...
		<div class="accordion-group">
			...
			<div class="accordion-body in collapse" id="user_all">
				<table class="table table-oddtd m_b0">
					<tbody class="first-td-no-leftbd">
						<tr>
							<td><div align="right"><strong>{t}会员购物总额{/t}</strong></div></td>
							<td>{$user_all_turnover}</td>
							<td><div align="right"><strong>{t}每会员订单数{/t}</strong></div></td>
							<td>{$ave_user_ordernum}</td>
						</tr>
						<tr>
							<td><div align="right"><strong>{t}每会员购物额{/t}</strong></div></td>
		...
		<div class="accordion-group">
			...
			<div class="accordion-body in collapse" id="guest_all">
				<table class="table table-oddtd m_b0">
					<tbody class="first-td-no-leftbd">
						<tr>
							<td><div align="right"><strong>{t}匿名会员购物总额{/t}</strong></div></td>
							<td>{$guest_all_turnover}</td>
							<td><div align="right"><strong>{t}匿名会员订单总数{/t}</strong></div></td>
							<td>{$guest_order_num}</td>
						</tr>
						<tr>
							<td><div align="right"><strong>{t}匿名会员平均订单额{/t}</strong></div></td>
