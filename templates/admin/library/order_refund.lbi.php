				...
				<form class="form-horizontal" method="post" name="refundForm" action='{url path="orders/admin/process" args="&func=refund"}'>
					<fieldset>
						...
						<div class="control-group formSep control-group-small">
							...
							<div class="controls">
								<p>
									<label class="ecjiaf-dn" id="anonymous"><input type="radio" name="refund" value="1" />退回用户余额</label>
									<label><input type="radio" name="refund" value="2" checked='checked' />生成退款申请</label>
									<label><input name="refund" type="radio" value="3" />不处理，误操作时选择此项</label>
								</p>
							</div>
						</div>
						<div class="control-group formSep control-group-small">
