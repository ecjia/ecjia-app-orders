	...
	<div class="modal-dialog">
    	<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">{$lang.order_operate}</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" method="post" name="batchForm" action='{url path="orders/admin/operate_post"}'>
					<div class="form-group">
						<label class="control-label col-lg-3">{$lang.label_action_note}</label>
					...
					<div class="form-group ecjiaf-dn show_cancel_note">
						<label class="control-label col-lg-3">{$lang.label_cancel_note}</label>
						<div class="col-lg-6">
					...
					<div class="form-group ecjiaf-dn show_invoice_no">
						<label class="control-label col-lg-3">{$lang.label_invoice_no}</label>
						<div class="col-lg-6">
							<input class="form-control" name="invoice_no" type="text" />
						</div>
					</div>
					<div class="form-group ecjiaf-dn show_refund">
						<label class="control-label col-lg-3">{$lang.label_handle_refund}</label>
						<div class="col-lg-6 l_h30">
							<div class="anonymous ecjiaf-dn">
								<input type="radio" name="refund" value="1" id="refund_1"/>
								<label for="refund_1">{$lang.return_user_money}</label>
							</div>
							<div>
								<input type="radio" name="refund" value="2"  id="refund_2"/>
								<label for="refund_2">{$lang.create_user_account}</label>
							</div>
							<div>
								<input type="radio" name="refund" value="3"  id="refund_3"/>
								<label for="refund_3">{$lang.not_handle}</label>
							</div>
						</div>
					</div>
					<div class="form-group ecjiaf-dn show_refund">
						<label class="control-label col-lg-3">{$lang.label_refund_note}</label>
